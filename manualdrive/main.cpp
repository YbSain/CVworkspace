...
int main(void)
{
    ...
    VideoWriter savefile("manualdrive2.avi", 0, (double)30, Size(640, 360), true);
    ...
    while(true)
    {
        ...
        if (mx.kbhit())
        {
            ...
            switch(c)
            {
            case 'f': goal1 = 0; goal2 = 0; break;
            case ' ': goal1 = 0; goal2 = 0; break;
            case 'w': goal1 = 50; goal2 = -50; break;
            case 's': goal1 = -50; goal2 = 50; break;
            case 'a': goal1 = 30; goal2 = -50; break;
            case 'd': goal1 = 50; goal2 = -30; break;
            case 'q': goal1 += 20; goal2 += -20; break;
            case 'e': goal1 += -20; goal2 += 20; break;
